enemy_data = {
		initialize_animations: function(){
			...
			_animations[ENEMY.IDLE] = new Animation(spr_random_guy_idle,	[525,525]);
			_animations[ENEMY.WALK] = new Animation(spr_random_guy_walk,	[175,175,175,175,175,175,175,175]);
			_animations[ENEMY.RUN]  = new Animation(spr_random_guy_run,		[75,75,75,75,75,75,75,75,75,75,75,75]);
			_animations[ENEMY.JUMP] = new Animation(spr_random_guy_jump,	[275,275,275]);
			_animations[ENEMY.APEX] = new Animation(spr_random_guy_apex,	[25,25,25,25], ENEMY.FALL);
			_animations[ENEMY.FALL] = new Animation(spr_random_guy_fall,	[250,250,250]);
		
			return _animations;
		},
		move_speed: random_range(3,7)*ENEMY_SIZE,
		jump_speed: random_range(12,15)*ENEMY_SIZE,
		obstacle_range: 35,
